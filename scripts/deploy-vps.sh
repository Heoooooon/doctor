#!/usr/bin/env bash
# VPS(172.237.29.96) 배포 스크립트 — jsdentad.mycafe24.com (/opt/seoulegundc, pm2: seoulegundc, 포트 3000)
#
...
# - 서버에 nginx 앱이 2개다: egundc.com(3001, /var/www/seoulegun)과
#   jsdentad(3000, 이 앱). pm2 delete all 절대 금지 — seoulegundc만 다룬다.
set -euo pipefail
